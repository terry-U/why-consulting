...
const valueConflicts = [
  ...
  },
  {
    id: 4,
    head: "결과가 전부다",
    heart: "과정의 연결이 있어야 힘이 난다",
    gap: "간극 큼",
    gapLevel: "high",
    headDetail: "결과가 중요해요.",
    heartDetail: "누가, 왜, 어떻게 쓰는지 맥락이 보일 때 의미가 커집니다.",
    scene: "결과만 남긴 회의·문서는 공허했습니다. 사람과 맥락이 붙으면 의미가 오래 남았습니다.",
    bridge: "모든 문서 첫 단락에 사용자 시나리오 3줄(누가/어떤 문제/무엇이 달라지나)."
  },
  {
    id: 5,
    head: "실력을 증명해야 한다",
    heart: "난제의 실마리를 찾을 때 확신이 선다",
    gap: "간극 작음·잘 맞음",
    gapLevel: "low",
    headDetail: "나는 해낼 수 있는 사람이어야 해요.",
    heartDetail: "복잡한 문제의 실마리를 찾았을 때 가장 확신합니다.",
    scene: "이 부분은 말과 삶이 자연스럽게 맞았습니다. 도전이 곧 확신이었습니다.",
    bridge: "큰 문제를 작은 조각으로 나누고 중간 승리를 기록하세요."
  },
  {
    id: 6,
    head: "빨리 보여줘야 한다",
    heart: "느려도 사람이 달라지면 오래 간다",
    gap: "간극 보통",
    gapLevel: "medium",
    headDetail: "속도가 필요해요.",
    heartDetail: "누군가의 하루가 달라지는 장면이 오래 남습니다.",
    scene: "빠르게 끝내면 흔적이 얇게 남을 때가 있었습니다. 반대로, 사람의 변화가 보이면 시간이 지나도 기억됐습니다.",
    bridge: "다음 데모의 목표를 **\"누가 무엇이 달라지나?\"**로 1문장 적어두세요."
  }
];
