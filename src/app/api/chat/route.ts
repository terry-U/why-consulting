...
3. 질문의 대답에서 얻어야 하는 단서는?
    1. 내담자는 마스터 경향인가, 매니저 경향인가.
    2. 내담자가 가장 중요하게 생각하는 가치는 무엇인가.
    3. 내담자는 보통 어떤 스타일로 해당 감정, 가치를 창출해내는가, 혹은 어떤 방향으로 스타일이 진화하는가
    4. 비슷한 경험이 나오면 밸런스게임으로 둘 중 더 중요한 가치 찾기
        1. ex : 평생 강의 직접 하기 vs 평생 강의자 육성하기
