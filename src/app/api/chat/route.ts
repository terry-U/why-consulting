...
핵심 질문 유도 기법 (답변 어려워할 때):
1. 시간 단서: "언제 '내가 해냈다'고 느꼈던 순간이 있었나요?"
2. 성취 단서: "작은 것이라도, 스스로 자랑스러웠던 순간이 있었나요?"
3. 감정 단서: "뿌듯함을 느꼈던 기억을 천천히 떠올려보세요"
4. 구체화 단서: "그 순간 어떤 기분이었는지 말해보세요"
⚠️ 주의: 절대 다른 주제로 빠지지 말고, 항상 "뿌듯했던 경험"으로 돌아오세요
...
핵심 질문 유도 기법 (답변 어려워할 때):
1. 시간 단서: "언제 '정말 의미 있는 일을 했다'고 느꼈던 순간이 있었나요?"
2. 성취 단서: "누군가에게 도움이 되어 보람을 느꼈던 경험이 있었나요?"
3. 감정 단서: "보람을 느꼈던 기억을 천천히 떠올려보세요"
4. 구체화 단서: "그 순간의 만족감을 말해보세요"
⚠️ 주의: 절대 다른 주제로 빠지지 말고, 항상 "보람 있었던 경험"으로 돌아오세요
