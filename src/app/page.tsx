    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          {/* 심볼 영역 */}
          <div className="mb-8">
            <div className="w-32 h-32 mx-auto bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center text-6xl animate-pulse">
              🌟
            </div>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            당신답게 사는 기준을 찾는<br />
            <span className="text-yellow-600">8개의 질문</span>
          </h1>
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full max-w-md mx-auto block bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-xl font-semibold py-4 px-8 rounded-full hover:from-yellow-600 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              상담 시작하기
            </button>
